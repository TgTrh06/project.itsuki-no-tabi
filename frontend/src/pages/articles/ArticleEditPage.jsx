...
export default function ArticleEditPage() {
  ...
  if (fetching) {
    return <div className="p-4 text-center text-muted-foreground">Loading article...</div>
  }
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold text-foreground font-serif mb-2">Edit Article</h1>
            <p className="text-muted-foreground">Update article content and metadata</p>
          </motion.div>
